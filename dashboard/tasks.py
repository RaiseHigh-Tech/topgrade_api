...
def send_certificates_email_task(self, course_progress_id):
    ...
    try:
        ...
        program_name = course_progress.purchase.program.subtitle
        
        subject = "Certificates of Completion - TopGrade Innovation"
        
        message = f"""Dear {student_name},

Congratulations on successfully completing your program with TopGrade Innovation Pvt. Ltd. We appreciate your dedication and commitment throughout the training or internship period.
Your Certificates of Completion are attached to this email. Every certificate issued by TopGrade Innovation includes a unique verification ID.
